...
def main():
    ...
    save_path = "/home/kas/kas_workspace/share/chenkai/playground/output/cls_prompt/qwen3_rewared_3epoch_0704"  # 保存路径
    ...
    model.to(torch.device("cuda" if torch.cuda.is_available() else "cpu"))  # 确保模型在GPU上
    print("model to cuda:")
